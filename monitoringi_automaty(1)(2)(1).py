...
sekcja = st.sidebar.radio(
    'Wybierz monitoring:',
    ('Alergia','Cera+','Ibunoven','Ketoprofen','Musy','Oferta sezonowa','Panthenol', 'Plastry','Standy wrzesień-marzec','Symetykon', 'Zimowe wzmocnienie odporności','Zgaginstop')
 )
...
if sekcja == 'Ibunoven':
    ...
    if df:
        ...
        if 'Pakiet' in xls.sheet_names:
            Lg = pd.read_excel(df, sheet_name='Rabat', skiprows=13, usecols=[1, 3, 8])
